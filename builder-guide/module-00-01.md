...
- [ ] TACC account + MFA set up (not used in this module, but confirm it's done)
...
1. Go to the template repos (link provided by your facilitator):
   - `course-site` (this becomes your **public** repo)
   - `course-toolkit` (this becomes your **private** repo)
