...
**Time:** Day 5, 10:15–11:00 AM (shared block with Module 10; see facilitator note)
...
- Modules 09 and 10 share a single 45-minute block. Publishing (this module) has a hard prerequisite step; the leak check below; that shouldn't be rushed. Recommend capping this module at ~25 minutes and treating Module 10 as more of a guided discussion than a hands-on build, given the time.
